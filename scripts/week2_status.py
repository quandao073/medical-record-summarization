...
checks = [
    ("data/medical_summarization/assembled/P001.json exists",      (ROOT / "data/medical_summarization/assembled/P001.json").exists()),
    ("data/medical_summarization/assembled/P002.json exists",      (ROOT / "data/medical_summarization/assembled/P002.json").exists()),
    ("data/medical_summarization/assembled/P003.json exists",      (ROOT / "data/medical_summarization/assembled/P003.json").exists()),
    ("data/medical_summarization/assembled/P004.json exists",      (ROOT / "data/medical_summarization/assembled/P004.json").exists()),
    ("data/medical_summarization/stores/P001_store.json exists",   (ROOT / "data/medical_summarization/stores/P001_store.json").exists()),
    ...
    ("configs/config.yaml exists",           (ROOT / "configs/config.yaml").exists()),
...
try:
    ...
    ehr = load_and_process(ROOT / "data/medical_summarization/assembled/P001.json")
...
poc_out = ROOT / "data/poc_outputs/P001_poc_summary.json"
...
if poc_out.exists():
    ...
    checks.append((f"PoC sections == 8 (got {sections})", sections == 8))
